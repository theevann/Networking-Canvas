...
public class LigneDroite extends Motif{
	...
	public boolean estIntersecteParLigneHorizontale(LigneDroite l){
		// Si les coefficients directeurs sont les memes, on renvoie false
		if((point1.y-point2.y) == 0)
			return false;
		
		double x = (l.point1.y*(point2.x-point1.x)+(point2.y*point1.x-point2.x*point1.y))/(point2.y-point1.y); //On calcule l'abscisse du point d'intersection ; l.point1.x egal e l.point2.x
	...
	public boolean estIntersecteParLigneVerticale(LigneDroite l){
		...
		double y = (l.point1.x*(point2.y-point1.y)-(point2.y*point1.x-point2.x*point1.y))/(point2.x-point1.x); //On calcule l'ordonnee du point d'intersection ; l.point1.y egal e l.point2.y
